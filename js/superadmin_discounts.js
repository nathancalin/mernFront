...
function deleteDiscount(discountId) {
    if (confirm('Are you sure you want to delete this discount?')) {
        fetch(`https://makimobackend.onrender.com/api/discounts/delete/${discountId}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        ...
        .then(data => {
            ...
            deleteNotification.style.color = 'green';
            deleteNotification.style.marginTop = '10px';
            deleteNotification.textContent = 'Discount deleted successfully!';
...
function deleteUsedDiscount(discountId) {
    if (confirm('Are you sure you want to delete this used discount?')) {
        fetch(`https://makimobackend.onrender.com/api/discounts/delete/${discountId}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
        ...
        .then(data => {
            ...
            deleteNotification.style.color = 'green';
            deleteNotification.style.marginTop = '10px';
            deleteNotification.textContent = 'Used discount deleted successfully!';
            document.body.appendChild(deleteNotification);
        ...
        .catch(error => console.error('Error deleting used discount:', error));
    }
}
...
function markAsUnused(discountId) {
    fetch(`https://makimobackend.onrender.com/api/discounts/markunused/${discountId}`, {
        method: 'PUT',
        headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
    ...
    .catch(error => console.error('Error marking discount as unused:', error));
}
